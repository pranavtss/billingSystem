              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center w-full mb-2">
                    ...
                    <span className="px-2 py-1 rounded text-xs font-bold bg-green-100 text-green-800 shadow">Active</span>
                  </div>
                  <div className="text-base text-gray-700 mb-1 font-medium">📞 {customer.phone}</div>
                  <div className="text-lg text-blue-700 font-extrabold mb-2">Bill: ₹{total.toFixed(2)}</div>
